...
local my_mappings = {
	...
	{ "<leader>fg", desc = "Resume previous find" },
	...
	{ "<leader>fc", desc = "Find Settings" },


	-- Buffer
	{ "<leader>b", name = "Buffer", icon = { icon = "󰓩", color = "white" } },
	{ "<leader>b]", desc = "Go to next buffer" },
	{ "<leader>b[", desc = "Go to previous buffer" },
	...
	-- Version Control
	{ "<leader>v", group = "Version Control", icon = { icon = "", color = "green" } },
	{ "<leader>v]", desc = "Next hunk" },
	{ "<leader>v[", desc = "Previous hunk" },
	{ "<leader>vp", desc = "View hunk" },
	{ "<leader>vd", desc = "Preview diff" },
	{ "<leader>vD", desc = "Preview diff (last commit)" },
	...
	{ "<leader>]", hidden = true },
	{ "<F5>", hidden = true },
	{ "<leader><F5>", hidden = true },
	{ "<F9>", hidden = true },
	{ "<leader><F9>", hidden = true },
	{ "<F10>", hidden = true },
	{ "<leader><F10>", hidden = true },
	{ "<F11>", hidden = true },
	{ "<leader><F11>", hidden = true },
	{ "<F12>", hidden = true },
	{ "<leader><F12>", hidden = true },
	{ "<leader><Tab>", hidden = true },
	{ "<leader><Up>", hidden = true },
	{ "<leader><Down>", hidden = true },
	{ "<leader><Left>", hidden = true },
	{ "<leader><Right>", hidden = true },
	{ "<leader><S-Left>", hidden = true },
	{ "<leader><S-Right>", hidden = true },
